...
def parse_args():
    ...
    # 增大阈值
    parser.add_argument('--w', default=0.8, type=float, help='The relation confidence threshold ω')
    ...
    # # training arguments
    parser.add_argument('--seed', default=208, type=int, help='seed for reproducibility')
