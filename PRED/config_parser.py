...
def get_args_parser():
    ...
    parser.add_argument("--dataset_type", default="esl", choices=["esl"], type=str,
                        help="dataset")
    parser.add_argument("--role_path", default='./data/event_typeinfo/description_esl.csv', type=str,
                        help="a file containing all role names. Read it to access all argument roles of this dataset")
    parser.add_argument("--prompt_path", default='./data/prompts/prompts_esl_full.csv', type=str,
    ...
    parser.add_argument("--max_enc_seq_length", default=120, type=int,
    ...
    parser.add_argument('--inference_model_path', default="./outputs/checkpoint", type=str,
                        help="The path of checkpoint used for inference.")
    # setting only for base model.
    parser.add_argument("--max_dec_seq_length", default=120, type=int,
                        help="maximum length for single prompt")
    parser.add_argument("--max_span_num", default=2, type=int,#1
